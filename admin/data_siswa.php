            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="?edit=<?php echo $row['id_siswa']; ?>" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button onclick="confirmDelete('?delete=<?php echo $row['id_siswa']; ?>')" class="btn btn-sm btn-danger">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background: var(--primary-yellow); color: var(--primary-black);">
                <h5 class="modal-title">
                    ...
                    <?php echo $edit_data ? 'Edit Siswa' : 'Tambah Siswa'; ?>
                </h5>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <?php if ($edit_data): ?>
                        <input type="hidden" name="id_siswa" value="<?php echo $edit_data['id_siswa']; ?>">
                    <?php endif; ?>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nama Lengkap *</label>
                            <input type="text" name="nama_siswa" class="form-control" value="<?php echo $edit_data['nama_siswa'] ?? ''; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kelas" class="form-control" placeholder="X-1" value="<?php echo $edit_data['kelas'] ?? ''; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Jenis Kelamin *</label>
                            <select name="jenis_kelamin" class="form-control" required>
                                <option value="">Pilih</option>
                                <option value="L" <?php echo ($edit_data['jenis_kelamin'] ?? '') == 'L' ? 'selected' : ''; ?>>Laki-laki</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control" value="<?php echo $edit_data['tempat_lahir'] ?? ''; ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" class="form-control" value="<?php echo $edit_data['tanggal_lahir'] ?? ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="no_telp" class="form-control" value="<?php echo $edit_data['no_telp'] ?? ''; ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_wali" class="form-control" value="<?php echo $edit_data['nama_wali'] ?? ''; ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">No. Telepon Wali</label>
                            <input type="text" name="no_telp_wali" class="form-control" value="<?php echo $edit_data['no_telp_wali'] ?? ''; ?>">
                        </div>
                    </div>
